    ...
    <div v-else class="os-tab-body">
      ...
      <template v-else-if="tab === 'delegation'">
        ...
        <label class="os-check disabled"
          ><input type="radio" checked disabled /> Do not trust this computer for delegation</label
        ><br />
        <label class="os-check disabled"
        ...
        ><br />
        <label class="os-check disabled"
          ><input type="radio" disabled /> Trust this computer for delegation to specified services
          only</label
        >
